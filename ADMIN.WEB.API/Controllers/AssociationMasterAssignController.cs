...
{
    public class AssociationMasterAssignController : ApiController
    {
        ...
        /// </remarks>
        /// <returns></returns>
        [Route("AssocMasterAssign")]
        public object Post([FromBody] AssMasterAssign ama)
        {
            ...
            try
            {
                ...
                {
                    result = biz.AssingAssMaster(ama.assIdx, ama.memberIdx, editMember);
                }
            }
            catch (Exception e)
            {
